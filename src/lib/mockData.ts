...
export const houseLocations: Record<string, HouseLocation> = {
  ...
  "Patrícia": {
    houseName: "Casa da Patrícia",
    address: "Rua Reverendo Professor Eliel de Almeida Martins, 203 - Vista Verde, São José dos Campos - SP",
    mapsLink: "https://maps.app.goo.gl/G1XmaAWDo6aZ4Ckk6",
  },
};
...
export const mockMonthlySchedule: MonthlySchedule = {
  ...
  weeks: [
    ...
    },
    {
      ...
      mapsLink: "https://maps.app.goo.gl/54Chr1MN7wjvKPg16",
      assignments: {
        casa: ["Guilherme", "Ana Carla"],
        quebraGelo: ["Guilherme", "Ana Carla"],
        estudo: ["Adriano"],
        salinha: ["Marcelo", "Andreia"],
      },
    },
    {
      id: "w5",
      weekNumber: 5,
      label: "Semana 05 - Sexta - Noite de Oração",
      date: "2026-07-31",
      isPrayerNight: true,
...
export const mockNotices: Notice[] = [
  {
    id: "1",
    title: "EBF - Terça a Quinta",
    description: "Dias 14, 15 e 16 de Julho • Horário: 14:00 às 17:30",
    date: "2026-07-14",
    pinned: false,
  },
];
